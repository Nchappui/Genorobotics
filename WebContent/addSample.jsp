	...
	<div align="center">
		...
		<form action="<%=request.getContextPath()%>/addsample" method="post">
			<table style="with: 100%">
				...
				<tr>
					<td>Sequencing datetime (format: YYYY-MM-DD HH:MM:SS, for
						example 2021-01-01 12:00:00)</td>
					<td><input type="text" name="sequencingTimestamp" required></td>
				</tr>
				<tr>
					<td>Amplification datetime (format: YYYY-MM-DD HH:MM:SS, for
						example 2021-01-01 12:00:00)</td>
					<td><input type="text" name="amplificationTimestamp" required></td>
				</tr>
				<tr>
					<td>Extraction datetime (format: YYYY-MM-DD HH:MM:SS, for
						example 2021-01-01 12:00:00)</td>
					<td><input type="text" name="extractionTimestamp" required></td>
				</tr>
				<tr>
					<td>Primer codes</td>
					<td><input type="text" name="primerCodes" required></td>
				</tr>
				<tr>
					<td>Read direction</td>
					<td><input type="radio" id="direction1" name="readDirection"
						value="Forward" required> <label for="direction1">Forward</label>
						<input type="radio" id="direction2" name="readDirection"
						value="Reverse"> <label for="direction2">Reverse</label></td>
				</tr>
				<tr>
					<td>Sequence length</td>
					<td><input type="number" name="sequenceLength" min="0"
						required></td>
				</tr>
				<tr>
					<td>Marker</td>
					<td><input type="text" name="marker" required></td>
				</tr>
				<tr>
					<td>Primer description</td>
					<td><input type="text" name="primerDescription" required></td>
				</tr>
				<tr>
					<td>Sequence data</td>
					<td><input type="text" name="sequenceData" required></td>
				</tr>
				<tr>
					<td>Base calling file</td>
					<td><input type="text" name="baseCallingFile" required></td>
				</tr>
